...
final class TolerantTwigEnvironmentFactory
{
     ...
     */
    public function __construct(PrivatesAccessor $privatesAccessor, Environment $twigEnvironment, \TomasVotruba\Torch\Twig\TolerantTwigFunctionFilterDecorator $tolerantTwigFunctionFilterDecorator, FormFactoryInterface $formFactory, iterable $twigEnvironmentDecorators)
    {
    ...
    public function create(array $twigFiles) : \TomasVotruba\Torch\Twig\TolerantTwigEnvironment
    {
        ...
        return new \TomasVotruba\Torch\Twig\TolerantTwigEnvironment($isolatedEnvironment, $this->formFactory);
    }
    /**
     * @param string[] $twigFiles
     */
