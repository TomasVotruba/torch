...
use Torch202308\TomasVotruba\Torch\Exception\TwigConstantNotFoundException;
use Torch202308\TomasVotruba\Torch\ValueObject\FilterNamesAndFunctionNames;
...
final class TolerantTwigFunctionFilterDecorator
{
    ...
    public function __construct(TwigCoreFunctionsAndFiltersResolver $twigCoreFunctionsAndFiltersResolver)
    {
