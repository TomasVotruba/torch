 ...
 */
namespace Torch202308\Composer;

use Torch202308\Composer\Autoload\ClassLoader;
use Torch202308\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('Torch202308\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
