...
use Torch202401\Symfony\Component\Console\CI\GithubActionReporter;
...
use Torch202401\Twig\Loader\ArrayLoader;
...
EOF
    ...
    private function renderException(SymfonyStyle $output, string $template, Error $exception, string $file = null, GithubActionReporter $githubReporter = null) : void
    {
        ...
        ($nullsafeVariable1 = $githubReporter) ? $nullsafeVariable1->error($exception->getRawMessage(), $file, $line <= 0 ? null : $line) : null;
        if ($file) {
