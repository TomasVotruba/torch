 ...
 */
namespace Torch202401\Symfony\Bridge\Twig\DataCollector;

use Torch202401\Symfony\Component\HttpFoundation\Request;
use Torch202401\Symfony\Component\HttpFoundation\Response;
use Torch202401\Symfony\Component\HttpKernel\DataCollector\DataCollector;
use Torch202401\Symfony\Component\HttpKernel\DataCollector\LateDataCollectorInterface;
use Twig\Environment;
use Torch202401\Twig\Error\LoaderError;
use Torch202401\Twig\Markup;
use Torch202401\Twig\Profiler\Dumper\HtmlDumper;
...
class TwigDataCollector extends DataCollector implements LateDataCollectorInterface
{
    ...
    {
        return $this->profile = $this->profile ?? \unserialize($this->data['profile'], ['allowed_classes' => ['Twig_Profiler_Profile', Profile::class]]);
    }
    /**
     * @return mixed
     */
    ...
    {
        $this->computed = $this->computed ?? $this->computeData($this->getProfile());
