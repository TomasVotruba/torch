...
use Torch202401\Symfony\Component\Mime\Address;
use Torch202401\Symfony\Component\Mime\Part\DataPart;
use Torch202401\Symfony\Component\Mime\Part\File;
...
final class WrappedTemplatedEmail
{
     ...
     */
    private $message;
    public function __construct(Environment $twig, \Symfony\Bridge\Twig\Mime\TemplatedEmail $message)
    {
        $this->twig = $twig;
