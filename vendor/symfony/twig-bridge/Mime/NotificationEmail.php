 ...
 */
namespace Torch202401\Symfony\Bridge\Twig\Mime;

use Torch202401\Symfony\Component\ErrorHandler\Exception\FlattenException;
use Torch202401\Symfony\Component\Mime\Header\Headers;
use Torch202401\Symfony\Component\Mime\Part\AbstractPart;
use Torch202401\Symfony\Component\Mime\Part\DataPart;
use Torch202401\Twig\Extra\CssInliner\CssInlinerExtension;
use Torch202401\Twig\Extra\Inky\InkyExtension;
use Torch202401\Twig\Extra\Markdown\MarkdownExtension;
/**
...
class NotificationEmail extends TemplatedEmail
{
     ...
     * @var mixed[]
     */
    private $context = ['importance' => self::IMPORTANCE_LOW, 'content' => '', 'exception' => \false, 'action_text' => null, 'action_url' => null, 'markdown' => \false, 'raw' => \false, 'footer_text' => 'Notification email sent by Symfony'];
    /**
     * @var bool
     */
    ...
    /**
     * @return $this
     * @param \Throwable|\Symfony\Component\ErrorHandler\Exception\FlattenException $exception
     */
