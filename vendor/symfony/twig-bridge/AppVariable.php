...
use Torch202401\Symfony\Component\HttpFoundation\Session\SessionInterface;
use Torch202401\Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorageInterface;
use Torch202401\Symfony\Component\Security\Core\Authentication\Token\TokenInterface;
use Torch202401\Symfony\Component\Security\Core\User\UserInterface;
...
class AppVariable
{
    ...
    public function getUser() : ?UserInterface
    {
        ...
        return ($nullsafeVariable1 = $this->tokenStorage->getToken()) ? $nullsafeVariable1->getUser() : null;
    }
    /**
    ...
    public function getSession() : ?SessionInterface
    {
        ...
        return (($nullsafeVariable2 = $request) ? $nullsafeVariable2->hasSession() : null) ? $request->getSession() : null;
    }
    /**
    ...
    public function getCurrent_route() : ?string
    {
        ...
        return (($nullsafeVariable3 = $this->getRequest()) ? $nullsafeVariable3->attributes : null)->get('_route');
    }
    /**
    ...
    public function getCurrent_route_parameters() : array
    {
        ...
        return (($nullsafeVariable4 = $this->getRequest()) ? $nullsafeVariable4->attributes : null)->get('_route_params') ?? [];
    }
}
