 ...
 */
namespace Torch202401\Symfony\Bridge\Twig\Test;

use Torch202401\Symfony\Bridge\Twig\Form\TwigRendererEngine;
use Torch202401\Symfony\Bridge\Twig\Test\Traits\RuntimeLoaderProvider;
use Torch202401\Symfony\Component\Form\FormRenderer;
use Torch202401\Symfony\Component\Form\FormRendererInterface;
use Torch202401\Symfony\Component\Form\FormView;
use Torch202401\Symfony\Component\Form\Test\FormIntegrationTestCase;
use Torch202401\Symfony\Component\Security\Csrf\CsrfTokenManagerInterface;
...
abstract class FormLayoutTestCase extends FormIntegrationTestCase
{
    ...
    protected abstract function getTemplatePaths() : array;
    protected abstract function getTwigExtensions() : array;
    protected function getTwigGlobals() : array
    {
        return [];
    }
    protected abstract function getThemes() : array;
