...
use Torch202308\Symfony\Component\Security\Acl\Voter\FieldVote;
use Torch202308\Symfony\Component\Security\Core\Authorization\AuthorizationCheckerInterface;
use Torch202308\Symfony\Component\Security\Core\Exception\AuthenticationCredentialsNotFoundException;
use Torch202308\Symfony\Component\Security\Http\Impersonate\ImpersonateUrlGenerator;
...
final class SecurityExtension extends AbstractExtension
{
    ...
    {
        return [new TwigFunction('is_granted', \Closure::fromCallable([$this, 'isGranted'])), new TwigFunction('impersonation_exit_url', \Closure::fromCallable([$this, 'getImpersonateExitUrl'])), new TwigFunction('impersonation_exit_path', \Closure::fromCallable([$this, 'getImpersonateExitPath']))];
    }
}
