...
use Torch202401\Symfony\Component\Routing\Generator\UrlGeneratorInterface;
...
final class RoutingExtension extends AbstractExtension
{
    ...
    {
        return [new TwigFunction('url', \Closure::fromCallable([$this, 'getUrl']), ['is_safe_callback' => \Closure::fromCallable([$this, 'isUrlGenerationSafe'])]), new TwigFunction('path', \Closure::fromCallable([$this, 'getPath']), ['is_safe_callback' => \Closure::fromCallable([$this, 'isUrlGenerationSafe'])])];
    }
