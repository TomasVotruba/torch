...
{
    /**
     * @var string|\Symfony\Component\ErrorHandler\ErrorRenderer\FileLinkFormatter|mixed[]|false
     */
    ...
    private $projectDir;
    /**
     * @param string|\Symfony\Component\ErrorHandler\ErrorRenderer\FileLinkFormatter $fileLinkFormat
     */
    ...
    {
        return [new TwigFilter('abbr_class', \Closure::fromCallable([$this, 'abbrClass']), ['is_safe' => ['html'], 'pre_escape' => 'html']), new TwigFilter('abbr_method', \Closure::fromCallable([$this, 'abbrMethod']), ['is_safe' => ['html'], 'pre_escape' => 'html']), new TwigFilter('format_args', \Closure::fromCallable([$this, 'formatArgs']), ['is_safe' => ['html']]), new TwigFilter('format_args_as_text', \Closure::fromCallable([$this, 'formatArgsAsText'])), new TwigFilter('file_excerpt', \Closure::fromCallable([$this, 'fileExcerpt']), ['is_safe' => ['html']]), new TwigFilter('format_file', \Closure::fromCallable([$this, 'formatFile']), ['is_safe' => ['html']]), new TwigFilter('format_file_from_text', \Closure::fromCallable([$this, 'formatFileFromText']), ['is_safe' => ['html']]), new TwigFilter('format_log_message', \Closure::fromCallable([$this, 'formatLogMessage']), ['is_safe' => ['html']]), new TwigFilter('file_link', \Closure::fromCallable([$this, 'getFileLink'])), new TwigFilter('file_relative', \Closure::fromCallable([$this, 'getFileRelative']))];
    }
    ...
    public function formatArgs(array $args) : string
    {
        ...
        foreach ($args as $key => $item) {
            if ('object' === $item[0]) {
                ...
                $formattedValue = \sprintf('<em>array</em>(%s)', \is_array($item[1]) ? $this->formatArgs($item[1]) : \htmlspecialchars(\var_export($item[1], \true), \ENT_COMPAT | \ENT_SUBSTITUTE, $this->charset));
            } elseif ('null' === $item[0]) {
                $formattedValue = '<em>null</em>';
            } elseif ('boolean' === $item[0]) {
                $formattedValue = '<em>' . \strtolower(\htmlspecialchars(\var_export($item[1], \true), \ENT_COMPAT | \ENT_SUBSTITUTE, $this->charset)) . '</em>';
