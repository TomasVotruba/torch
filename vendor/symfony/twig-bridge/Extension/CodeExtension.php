...
use Torch202308\Symfony\Component\HttpKernel\Debug\FileLinkFormatter;
...
{
    /**
     * @var string|\Symfony\Component\HttpKernel\Debug\FileLinkFormatter|mixed[]|false
     */
    ...
    {
        return [new TwigFilter('abbr_class', \Closure::fromCallable([$this, 'abbrClass']), ['is_safe' => ['html']]), new TwigFilter('abbr_method', \Closure::fromCallable([$this, 'abbrMethod']), ['is_safe' => ['html']]), new TwigFilter('format_args', \Closure::fromCallable([$this, 'formatArgs']), ['is_safe' => ['html']]), new TwigFilter('format_args_as_text', \Closure::fromCallable([$this, 'formatArgsAsText'])), new TwigFilter('file_excerpt', \Closure::fromCallable([$this, 'fileExcerpt']), ['is_safe' => ['html']]), new TwigFilter('format_file', \Closure::fromCallable([$this, 'formatFile']), ['is_safe' => ['html']]), new TwigFilter('format_file_from_text', \Closure::fromCallable([$this, 'formatFileFromText']), ['is_safe' => ['html']]), new TwigFilter('format_log_message', \Closure::fromCallable([$this, 'formatLogMessage']), ['is_safe' => ['html']]), new TwigFilter('file_link', \Closure::fromCallable([$this, 'getFileLink'])), new TwigFilter('file_relative', \Closure::fromCallable([$this, 'getFileRelative']))];
    }
