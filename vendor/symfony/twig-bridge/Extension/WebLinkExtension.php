...
use Torch202308\Symfony\Component\WebLink\GenericLinkProvider;
use Torch202308\Symfony\Component\WebLink\Link;
...
final class WebLinkExtension extends AbstractExtension
{
    ...
    {
        return [new TwigFunction('link', \Closure::fromCallable([$this, 'link'])), new TwigFunction('preload', \Closure::fromCallable([$this, 'preload'])), new TwigFunction('dns_prefetch', \Closure::fromCallable([$this, 'dnsPrefetch'])), new TwigFunction('preconnect', \Closure::fromCallable([$this, 'preconnect'])), new TwigFunction('prefetch', \Closure::fromCallable([$this, 'prefetch'])), new TwigFunction('prerender', \Closure::fromCallable([$this, 'prerender']))];
    }
    /**
