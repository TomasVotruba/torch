...
use Torch202308\Symfony\Bridge\Twig\TokenParser\DumpTokenParser;
use Torch202308\Symfony\Component\VarDumper\Cloner\ClonerInterface;
use Torch202308\Symfony\Component\VarDumper\Dumper\HtmlDumper;
...
final class DumpExtension extends AbstractExtension
{
    ...
    private $cloner;
    /**
     * @var \Symfony\Component\VarDumper\Dumper\HtmlDumper|null
     */
    private $dumper;
    ...
    {
        return [new TwigFunction('dump', \Closure::fromCallable([$this, 'dump']), ['is_safe' => ['html'], 'needs_context' => \true, 'needs_environment' => \true])];
    }
