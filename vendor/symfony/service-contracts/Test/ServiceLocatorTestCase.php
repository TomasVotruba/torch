 ...
 */
namespace Torch202308\Symfony\Contracts\Service\Test;

use Torch202308\PHPUnit\Framework\TestCase;
use Torch202308\Psr\Container\ContainerInterface;
use Torch202308\Symfony\Contracts\Service\ServiceLocatorTrait;
abstract class ServiceLocatorTestCase extends TestCase
{
    ...
    public function testThrowsOnUndefinedInternalService()
    {
        if (!$this->getExpectedException()) {
            $this->expectException(\Torch202308\Psr\Container\NotFoundExceptionInterface::class);
    ...
    {
        $this->expectException(\Torch202308\Psr\Container\ContainerExceptionInterface::class);
