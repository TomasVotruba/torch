...
class Environment
{
    ...
    public function __construct(LoaderInterface $loader, $options = [])
    {
        ...
        $options = \array_merge(['debug' => \false, 'charset' => 'UTF-8', 'base_template_class' => \Twig\Template::class, 'strict_variables' => \false, 'autoescape' => 'html', 'cache' => \false, 'auto_reload' => null, 'optimizations' => -1], $options);
        $this->debug = (bool) $options['debug'];
        $this->setCharset($options['charset']);
        $this->baseTemplateClass = '\\' . \ltrim($options['base_template_class'], '\\');
        if ('\\' . \Twig\Template::class !== $this->baseTemplateClass && '\\Twig_Template' !== $this->baseTemplateClass) {
