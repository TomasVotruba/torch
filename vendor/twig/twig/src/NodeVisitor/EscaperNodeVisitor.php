 ...
 */
final class EscaperNodeVisitor extends \Twig\NodeVisitor\AbstractNodeVisitor
{
    private $statusStack = [];
    private $blocks = [];
...
\class_alias('Twig\\NodeVisitor\\EscaperNodeVisitor', 'Torch202401\\Twig_NodeVisitor_Escaper');
