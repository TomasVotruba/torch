...
use Twig\Node\Node;
final class SafeAnalysisNodeVisitor extends \Twig\NodeVisitor\AbstractNodeVisitor
{
    private $data = [];
    private $safeVars = [];
...
\class_alias('Twig\\NodeVisitor\\SafeAnalysisNodeVisitor', 'Torch202401\\Twig_NodeVisitor_SafeAnalysis');
