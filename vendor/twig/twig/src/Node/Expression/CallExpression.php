...
abstract class CallExpression extends \Twig\Node\Expression\AbstractExpression
{
    ...
    protected function getArguments($callable, $arguments)
    {
        ...
        if ($isVariadic) {
            $arbitraryArguments = $isPhpVariadic ? new \Twig\Node\Expression\VariadicExpression([], -1) : new \Twig\Node\Expression\ArrayExpression([], -1);
...
\class_alias('Twig\\Node\\Expression\\CallExpression', 'Torch202401\\Twig_Node_Expression_Call');
