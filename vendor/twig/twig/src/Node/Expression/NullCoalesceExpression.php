...
class NullCoalesceExpression extends \Twig\Node\Expression\ConditionalExpression
{
    public function __construct(Node $left, Node $right, int $lineno)
    {
        ...
        if (!$left instanceof \Twig\Node\Expression\BlockReferenceExpression) {
...
\class_alias('Twig\\Node\\Expression\\NullCoalesceExpression', 'Torch202401\\Twig_Node_Expression_NullCoalesce');
