...
{
    public function __construct(\Twig\Node\Node $body, ?AbstractExpression $parent, \Twig\Node\Node $blocks, \Twig\Node\Node $macros, \Twig\Node\Node $traits, $embeddedTemplates, Source $source)
    {
        ...
        $nodes = ['body' => $body, 'blocks' => $blocks, 'macros' => $macros, 'traits' => $traits, 'display_start' => new \Twig\Node\Node(), 'display_end' => new \Twig\Node\Node(), 'constructor_start' => new \Twig\Node\Node(), 'constructor_end' => new \Twig\Node\Node(), 'class_end' => new \Twig\Node\Node()];
        if (null !== $parent) {
            $nodes['parent'] = $parent;
        }
...
\class_alias('Twig\\Node\\ModuleNode', 'Torch202401\\Twig_Node_Module');
