...
{
    private $loop;
    public function __construct(AssignNameExpression $keyTarget, AssignNameExpression $valueTarget, AbstractExpression $seq, ?AbstractExpression $ifexpr, \Twig\Node\Node $body, ?\Twig\Node\Node $else, int $lineno, string $tag = null)
    {
...
\class_alias('Twig\\Node\\ForNode', 'Torch202401\\Twig_Node_For');
