...
use Torch202308\Twig\ExpressionParser;
use Torch202308\Twig\Node\Expression\Binary\AddBinary;
use Torch202308\Twig\Node\Expression\Binary\AndBinary;
use Torch202308\Twig\Node\Expression\Binary\BitwiseAndBinary;
use Torch202308\Twig\Node\Expression\Binary\BitwiseOrBinary;
use Torch202308\Twig\Node\Expression\Binary\BitwiseXorBinary;
use Torch202308\Twig\Node\Expression\Binary\ConcatBinary;
use Torch202308\Twig\Node\Expression\Binary\DivBinary;
use Torch202308\Twig\Node\Expression\Binary\EndsWithBinary;
use Torch202308\Twig\Node\Expression\Binary\EqualBinary;
use Torch202308\Twig\Node\Expression\Binary\FloorDivBinary;
use Torch202308\Twig\Node\Expression\Binary\GreaterBinary;
use Torch202308\Twig\Node\Expression\Binary\GreaterEqualBinary;
use Torch202308\Twig\Node\Expression\Binary\InBinary;
use Torch202308\Twig\Node\Expression\Binary\LessBinary;
use Torch202308\Twig\Node\Expression\Binary\LessEqualBinary;
use Torch202308\Twig\Node\Expression\Binary\MatchesBinary;
use Torch202308\Twig\Node\Expression\Binary\ModBinary;
use Torch202308\Twig\Node\Expression\Binary\MulBinary;
use Torch202308\Twig\Node\Expression\Binary\NotEqualBinary;
use Torch202308\Twig\Node\Expression\Binary\NotInBinary;
use Torch202308\Twig\Node\Expression\Binary\OrBinary;
use Torch202308\Twig\Node\Expression\Binary\PowerBinary;
use Torch202308\Twig\Node\Expression\Binary\RangeBinary;
use Torch202308\Twig\Node\Expression\Binary\SpaceshipBinary;
use Torch202308\Twig\Node\Expression\Binary\StartsWithBinary;
use Torch202308\Twig\Node\Expression\Binary\SubBinary;
use Torch202308\Twig\Node\Expression\Filter\DefaultFilter;
use Torch202308\Twig\Node\Expression\NullCoalesceExpression;
use Torch202308\Twig\Node\Expression\Test\ConstantTest;
use Torch202308\Twig\Node\Expression\Test\DefinedTest;
use Torch202308\Twig\Node\Expression\Test\DivisiblebyTest;
use Torch202308\Twig\Node\Expression\Test\EvenTest;
use Torch202308\Twig\Node\Expression\Test\NullTest;
use Torch202308\Twig\Node\Expression\Test\OddTest;
use Torch202308\Twig\Node\Expression\Test\SameasTest;
use Torch202308\Twig\Node\Expression\Unary\NegUnary;
use Torch202308\Twig\Node\Expression\Unary\NotUnary;
use Torch202308\Twig\Node\Expression\Unary\PosUnary;
use Torch202308\Twig\NodeVisitor\MacroAutoImportNodeVisitor;
use Torch202308\Twig\TokenParser\ApplyTokenParser;
use Torch202308\Twig\TokenParser\BlockTokenParser;
use Torch202308\Twig\TokenParser\DeprecatedTokenParser;
use Torch202308\Twig\TokenParser\DoTokenParser;
use Torch202308\Twig\TokenParser\EmbedTokenParser;
use Torch202308\Twig\TokenParser\ExtendsTokenParser;
use Torch202308\Twig\TokenParser\FilterTokenParser;
use Torch202308\Twig\TokenParser\FlushTokenParser;
use Torch202308\Twig\TokenParser\ForTokenParser;
use Torch202308\Twig\TokenParser\FromTokenParser;
use Torch202308\Twig\TokenParser\IfTokenParser;
use Torch202308\Twig\TokenParser\ImportTokenParser;
use Torch202308\Twig\TokenParser\IncludeTokenParser;
use Torch202308\Twig\TokenParser\MacroTokenParser;
use Torch202308\Twig\TokenParser\SetTokenParser;
use Torch202308\Twig\TokenParser\SpacelessTokenParser;
use Torch202308\Twig\TokenParser\UseTokenParser;
use Torch202308\Twig\TokenParser\WithTokenParser;
use Torch202308\Twig\TwigFilter;
use Torch202308\Twig\TwigFunction;
use Torch202308\Twig\TwigTest;
...
\class_alias('Torch202308\\Twig\\Extension\\CoreExtension', 'Torch202308\\Twig_Extension_Core');
namespace Torch202308;

use Twig\Environment;
use Torch202308\Twig\Error\LoaderError;
use Torch202308\Twig\Error\RuntimeError;
use Torch202308\Twig\Extension\CoreExtension;
use Torch202308\Twig\Extension\SandboxExtension;
use Torch202308\Twig\Markup;
use Torch202308\Twig\Source;
...
function twig_array_filter(Environment $env, $array, $arrow)
{
    ...
    if (\is_array($array)) {
        return \array_filter($array, $arrow === null ? function ($value, $key) : bool {
            return !empty($value);
...
{
    if (!$arrow instanceof \Closure && $env->hasExtension('Torch202308\\Twig\\Extension\\SandboxExtension') && $env->getExtension('Torch202308\\Twig\\Extension\\SandboxExtension')->isSandboxed()) {
