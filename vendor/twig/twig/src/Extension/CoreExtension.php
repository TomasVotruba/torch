...
final class CoreExtension extends \Twig\Extension\AbstractExtension
{
    ...
    {
        @\trigger_error(\sprintf('The "%s" method is deprecated since Twig 2.11; use "%s::setEscaper" instead.', __METHOD__, \Twig\Extension\EscaperExtension::class), \E_USER_DEPRECATED);
    ...
    public function getEscapers()
    {
        if (0 === \func_num_args() || \func_get_arg(0)) {
            @\trigger_error(\sprintf('The "%s" method is deprecated since Twig 2.11; use "%s::getEscapers" instead.', __METHOD__, \Twig\Extension\EscaperExtension::class), \E_USER_DEPRECATED);
        }
...
\class_alias('Twig\\Extension\\CoreExtension', 'Torch202401\\Twig_Extension_Core');
