...
use Torch202401\Twig\Node\NodeCaptureInterface;
use Torch202401\Twig\Node\NodeOutputInterface;
use Torch202401\Twig\Node\PrintNode;
use Torch202401\Twig\Node\SpacelessNode;
use Torch202401\Twig\Node\TextNode;
...
class Parser
{
    ...
    private function filterBodyNodes(Node $node, bool $nested = \false)
    {
        ...
        if ($nested && ($node instanceof BlockReferenceNode || $node instanceof \Torch202401\Twig_Node_BlockReference)) {
...
\class_alias('Torch202401\\Twig\\Parser', 'Torch202401\\Twig_Parser');
