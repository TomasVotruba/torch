 ...
 */
namespace Torch202308\Twig;

use Torch202308\Twig\Error\SyntaxError;
use Torch202308\Twig\Node\BlockNode;
use Torch202308\Twig\Node\BlockReferenceNode;
...
use Torch202308\Twig\Node\NodeCaptureInterface;
use Torch202308\Twig\Node\NodeOutputInterface;
use Torch202308\Twig\Node\PrintNode;
use Torch202308\Twig\Node\SpacelessNode;
use Torch202308\Twig\Node\TextNode;
use Torch202308\Twig\TokenParser\TokenParserInterface;
/**
...
class Parser
{
    ...
    private function filterBodyNodes(Node $node, bool $nested = \false)
    {
        ...
        if ($nested && ($node instanceof BlockReferenceNode || $node instanceof \Torch202308\Twig_Node_BlockReference)) {
...
\class_alias('Torch202308\\Twig\\Parser', 'Torch202308\\Twig_Parser');
