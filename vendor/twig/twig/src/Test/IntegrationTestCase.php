    ...
    protected function doIntegrationTest($file, $message, $condition, $templates, $exception, $outputs, $deprecation = '')
    {
        ...
        foreach ($outputs as $i => $match) {
            ...
            if (\false !== $exception) {
                ...
                $constraintClass = \class_exists('Torch202308\\PHPUnit\\Framework\\Constraint\\Exception') ? 'PHPUnit\\Framework\\Constraint\\Exception' : 'PHPUnit_Framework_Constraint_Exception';
...
\class_alias('Torch202308\\Twig\\Test\\IntegrationTestCase', 'Torch202308\\Twig_Test_IntegrationTestCase');
