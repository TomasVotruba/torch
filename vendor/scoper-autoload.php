...
'humbug_phpscoper_expose_class')// if (!function_exists('humbug_phpscoper_expose_class')) {
...
humbug_phpscoper_expose_class('ComposerAutoloaderInit9a9cda49e121772bbe3092c36f2ff608', 'Torch202308\ComposerAutoloaderInit9a9cda49e121772bbe3092c36f2ff608');
...
'_twig_default_filter')// if (!function_exists('_twig_default_filter')) { function _twig_default_filter() { return \Torch202308\_twig_default_filter(...func_get_args()); } }
'setproctitle')// if (!function_exists('setproctitle')) { function setproctitle() { return \Torch202308\setproctitle(...func_get_args()); } }
'trigger_deprecation')// if (!function_exists('trigger_deprecation')) { function trigger_deprecation() { return \Torch202308\trigger_deprecation(...func_get_args()); } }
'twig_array_batch')// if (!function_exists('twig_array_batch')) { function twig_array_batch() { return \Torch202308\twig_array_batch(...func_get_args()); } }
'twig_array_column')// if (!function_exists('twig_array_column')) { function twig_array_column() { return \Torch202308\twig_array_column(...func_get_args()); } }
'twig_array_filter')// if (!function_exists('twig_array_filter')) { function twig_array_filter() { return \Torch202308\twig_array_filter(...func_get_args()); } }
'twig_array_map')// if (!function_exists('twig_array_map')) { function twig_array_map() { return \Torch202308\twig_array_map(...func_get_args()); } }
'twig_array_merge')// if (!function_exists('twig_array_merge')) { function twig_array_merge() { return \Torch202308\twig_array_merge(...func_get_args()); } }
'twig_array_reduce')// if (!function_exists('twig_array_reduce')) { function twig_array_reduce() { return \Torch202308\twig_array_reduce(...func_get_args()); } }
'twig_call_macro')// if (!function_exists('twig_call_macro')) { function twig_call_macro() { return \Torch202308\twig_call_macro(...func_get_args()); } }
'twig_capitalize_string_filter')// if (!function_exists('twig_capitalize_string_filter')) { function twig_capitalize_string_filter() { return \Torch202308\twig_capitalize_string_filter(...func_get_args()); } }
'twig_check_arrow_in_sandbox')// if (!function_exists('twig_check_arrow_in_sandbox')) { function twig_check_arrow_in_sandbox() { return \Torch202308\twig_check_arrow_in_sandbox(...func_get_args()); } }
'twig_constant')// if (!function_exists('twig_constant')) { function twig_constant() { return \Torch202308\twig_constant(...func_get_args()); } }
'twig_constant_is_defined')// if (!function_exists('twig_constant_is_defined')) { function twig_constant_is_defined() { return \Torch202308\twig_constant_is_defined(...func_get_args()); } }
'twig_convert_encoding')// if (!function_exists('twig_convert_encoding')) { function twig_convert_encoding() { return \Torch202308\twig_convert_encoding(...func_get_args()); } }
'twig_cycle')// if (!function_exists('twig_cycle')) { function twig_cycle() { return \Torch202308\twig_cycle(...func_get_args()); } }
'twig_date_converter')// if (!function_exists('twig_date_converter')) { function twig_date_converter() { return \Torch202308\twig_date_converter(...func_get_args()); } }
'twig_date_format_filter')// if (!function_exists('twig_date_format_filter')) { function twig_date_format_filter() { return \Torch202308\twig_date_format_filter(...func_get_args()); } }
'twig_date_modify_filter')// if (!function_exists('twig_date_modify_filter')) { function twig_date_modify_filter() { return \Torch202308\twig_date_modify_filter(...func_get_args()); } }
'twig_ensure_traversable')// if (!function_exists('twig_ensure_traversable')) { function twig_ensure_traversable() { return \Torch202308\twig_ensure_traversable(...func_get_args()); } }
'twig_escape_filter')// if (!function_exists('twig_escape_filter')) { function twig_escape_filter() { return \Torch202308\twig_escape_filter(...func_get_args()); } }
'twig_escape_filter_is_safe')// if (!function_exists('twig_escape_filter_is_safe')) { function twig_escape_filter_is_safe() { return \Torch202308\twig_escape_filter_is_safe(...func_get_args()); } }
'twig_first')// if (!function_exists('twig_first')) { function twig_first() { return \Torch202308\twig_first(...func_get_args()); } }
'twig_get_array_keys_filter')// if (!function_exists('twig_get_array_keys_filter')) { function twig_get_array_keys_filter() { return \Torch202308\twig_get_array_keys_filter(...func_get_args()); } }
'twig_get_attribute')// if (!function_exists('twig_get_attribute')) { function twig_get_attribute() { return \Torch202308\twig_get_attribute(...func_get_args()); } }
'twig_in_filter')// if (!function_exists('twig_in_filter')) { function twig_in_filter() { return \Torch202308\twig_in_filter(...func_get_args()); } }
'twig_include')// if (!function_exists('twig_include')) { function twig_include() { return \Torch202308\twig_include(...func_get_args()); } }
'twig_join_filter')// if (!function_exists('twig_join_filter')) { function twig_join_filter() { return \Torch202308\twig_join_filter(...func_get_args()); } }
'twig_last')// if (!function_exists('twig_last')) { function twig_last() { return \Torch202308\twig_last(...func_get_args()); } }
'twig_length_filter')// if (!function_exists('twig_length_filter')) { function twig_length_filter() { return \Torch202308\twig_length_filter(...func_get_args()); } }
'twig_lower_filter')// if (!function_exists('twig_lower_filter')) { function twig_lower_filter() { return \Torch202308\twig_lower_filter(...func_get_args()); } }
'twig_nl2br')// if (!function_exists('twig_nl2br')) { function twig_nl2br() { return \Torch202308\twig_nl2br(...func_get_args()); } }
'twig_number_format_filter')// if (!function_exists('twig_number_format_filter')) { function twig_number_format_filter() { return \Torch202308\twig_number_format_filter(...func_get_args()); } }
'twig_random')// if (!function_exists('twig_random')) { function twig_random() { return \Torch202308\twig_random(...func_get_args()); } }
'twig_raw_filter')// if (!function_exists('twig_raw_filter')) { function twig_raw_filter() { return \Torch202308\twig_raw_filter(...func_get_args()); } }
'twig_replace_filter')// if (!function_exists('twig_replace_filter')) { function twig_replace_filter() { return \Torch202308\twig_replace_filter(...func_get_args()); } }
'twig_reverse_filter')// if (!function_exists('twig_reverse_filter')) { function twig_reverse_filter() { return \Torch202308\twig_reverse_filter(...func_get_args()); } }
'twig_round')// if (!function_exists('twig_round')) { function twig_round() { return \Torch202308\twig_round(...func_get_args()); } }
'twig_slice')// if (!function_exists('twig_slice')) { function twig_slice() { return \Torch202308\twig_slice(...func_get_args()); } }
'twig_sort_filter')// if (!function_exists('twig_sort_filter')) { function twig_sort_filter() { return \Torch202308\twig_sort_filter(...func_get_args()); } }
'twig_source')// if (!function_exists('twig_source')) { function twig_source() { return \Torch202308\twig_source(...func_get_args()); } }
'twig_spaceless')// if (!function_exists('twig_spaceless')) { function twig_spaceless() { return \Torch202308\twig_spaceless(...func_get_args()); } }
'twig_split_filter')// if (!function_exists('twig_split_filter')) { function twig_split_filter() { return \Torch202308\twig_split_filter(...func_get_args()); } }
'twig_sprintf')// if (!function_exists('twig_sprintf')) { function twig_sprintf() { return \Torch202308\twig_sprintf(...func_get_args()); } }
'twig_striptags')// if (!function_exists('twig_striptags')) { function twig_striptags() { return \Torch202308\twig_striptags(...func_get_args()); } }
'twig_template_from_string')// if (!function_exists('twig_template_from_string')) { function twig_template_from_string() { return \Torch202308\twig_template_from_string(...func_get_args()); } }
'twig_test_empty')// if (!function_exists('twig_test_empty')) { function twig_test_empty() { return \Torch202308\twig_test_empty(...func_get_args()); } }
'twig_test_iterable')// if (!function_exists('twig_test_iterable')) { function twig_test_iterable() { return \Torch202308\twig_test_iterable(...func_get_args()); } }
'twig_title_string_filter')// if (!function_exists('twig_title_string_filter')) { function twig_title_string_filter() { return \Torch202308\twig_title_string_filter(...func_get_args()); } }
'twig_to_array')// if (!function_exists('twig_to_array')) { function twig_to_array() { return \Torch202308\twig_to_array(...func_get_args()); } }
'twig_trim_filter')// if (!function_exists('twig_trim_filter')) { function twig_trim_filter() { return \Torch202308\twig_trim_filter(...func_get_args()); } }
'twig_upper_filter')// if (!function_exists('twig_upper_filter')) { function twig_upper_filter() { return \Torch202308\twig_upper_filter(...func_get_args()); } }
'twig_urlencode_filter')// if (!function_exists('twig_urlencode_filter')) { function twig_urlencode_filter() { return \Torch202308\twig_urlencode_filter(...func_get_args()); } }
'twig_var_dump')// if (!function_exists('twig_var_dump')) { function twig_var_dump() { return \Torch202308\twig_var_dump(...func_get_args()); } }
